...
## Command history anbd bash completion
...
- `scp` securely transfers files between machines using SSH.
    ...
    scp [LOCALFILE] [USERNAME]@server.ucla-biostat-203b.com:/[PATHTOFOLDER]
    ```
    ```{bash, eval=FALSE}
    ## copy file from remote to local
    scp [USERNAME]@server.ucla-biostat-203b.com:/[PATHTOFILE] [PATHTOLOCALFOLDER]
    ```
