...
- For Windows users, there are 2 ways: (1) [PuTTY](http://www.putty.org) program (free) and (2) use WSL for Windows to install a full fledged Linux system within Windows (Thursday lab).
