...
- For Windows users, there are 2 ways: (1) (recommended) [Git Bash](git bash commands), (2) (not recommended) [PuTTY](http://www.putty.org) program (free), or (3) (may be an overkill for this class)  use WSL for Windows to install a full fledged Linux system within Windows.
...
- [`runSim.R`](https://ucla-biostat203b-2020winter.github.io/slides/02-linux/runSim.R) has components: (1) method implementation, (2) data generator with unspecified parameter `n`, (3) estimation based on generated data, and (4) **command argument parser**.
```{bash, echo=FALSE}
cat runSim.R
```
...
- Suppose we have 
    - [`runSim.R`](https://ucla-biostat203b-2020winter.github.io/slides/02-linux/runSim.R) which runs a simulation based on command line argument `n`.  
...
- Let's demonstrate using the script [autoSim.R](https://ucla-biostat203b-2020winter.github.io/slides/02-linux/autoSim.R)
    ```{bash}
    cat autoSim.R
    ```
