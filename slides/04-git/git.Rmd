...
- Initialize a project.
    ...
    - Create a repository, e.g., `biostat-203b-2020-winter` on the server.
    
    - Clone the repository to your local machine:
    ```{bash, eval=FALSE}
    git clone git@github.com:[USERNAME]/biostat-203b-2020-winter.git
    ```
...
- Create a private repository `biostat-203b-2020-winter`. Add `Hua-Zhou` and `juhkim111` as your collaborators with write permission.
...
- Clone the repository, create `develop` branch, where your work on solutions.
    ...
    ```{bash, eval=FALSE}
    # clone the project
    git clone git@github.com:biostat-203b-2020-winter.git
    # enter project folder
    cd biostat-203b-2020-winter
