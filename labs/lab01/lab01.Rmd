...
1. SSH client on MacOS and Windows. 
    ...
    - Windows: download and install [`Git for Windows` aka `Git Bash`](https://gitforwindows.org).  This gives you a bash shell within Windows, which is also equipped with Git commands.

2. Connect to the teaching server. 
    - MacOS Terminal:  
    ```
...
4. On teaching server, obtain a copy of the course material using git:  
    ```
    git clone https://github.com/ucla-biostat203b-2020winter/ucla-biostat203b-2020winter.github.io.git
    ```

5. Check whether you already have SSH keys.
...
8. Register an account on GitHub, **using ucla.edu email**. Send GitHub handle to Juhyun Kim.
